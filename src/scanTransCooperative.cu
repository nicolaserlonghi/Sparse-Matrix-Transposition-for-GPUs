...
__global__
void transpositionCooperativeKernel(
    int     m,
    int     n,
    int     nnz,
    int     len,
...
float scanTransCooperative(
    ...
    void *args[] = {(void *)&m, (void *)&n, (void *)&nnz, (void *)&len, (void *)&d_csrRowPtr, (void *)&d_csrColIdx, (void *)&d_csrVal, (void *)&d_cscColPtr, (void *)&d_cscRowIdx, (void *)&d_cscVal, (void *)&d_csrRowIdx, (void *)&d_intra, (void *)&d_inter};

    cudaLaunchCooperativeKernel((void *)transpositionCooperativeKernel, DimGrid, DimBlock, args);

    TM_device.stop();
    cudaDeviceSynchronize();
    TM_device.print("GPU Sparse Matrix Transpostion ScanTrans Cooperative: ");    
